...
//     Phouse2("Phouse2"),
//     Phouse5("Phouse5")
CityPowerGrid::CityPowerGrid(sc_core::sc_module_name _name) :
...
void CityPowerGrid::set_attributes()
{
...
void CityPowerGrid::initialize()
{

}

void CityPowerGrid::processing()
{
...
//    Vwind_inv.write(vref_cti); //dcac converter for wind wind_turbine
...
//	std::cout << "Total load " << total_load << "\n";
    ...
    // Compute the total generation from PV and Wind wind_turbine
