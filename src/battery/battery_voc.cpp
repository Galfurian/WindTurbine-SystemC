#include "battery/battery_voc.hpp"

BatteryVoc::BatteryVoc(sc_core::sc_module_name _name) :
...
void BatteryVoc::set_attributes()
{
...
void BatteryVoc::initialize()
{

}

void BatteryVoc::processing()
{
